...
export const TRANSFER_EVENT = "Transfer(address indexed _from, address indexed _to, uint256 _value)"
...
export const ERC20_ABI = ["function totalSupply() external view returns (uint256)", "function balanceOf(address _owner) external view returns (uint256 balance)"]